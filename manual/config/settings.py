...
# KEY_PREFIX - строка, которая будет во все ключи кеша. По умолчанию ''.
...
# Соединение с кешем, которое будет использоваться для cache middleware.
CACHE_MIDDLEWARE_ALIAS = 'default'


# Строка, которая будет предваряться ключами кеша, созданными cache middleware. Сочетается с KEY_PREFIX.
CACHE_MIDDLEWARE_KEY_PREFIX = ''


# Число секунд по умолчанию для кеширования страницы для cache middleware.
